  ...
  (0, _createClass3.default)(Now, [{
    ...
    value: function getNameservers(domain) {
      ...
      return new _promise2.default(function (resolve) {
        ...
        _this8.retry(function () {
          var _ref19 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(bail, attempt) {
            var res, body;
              ...
              while (1) {
                switch (_context13.prev = _context13.next) {
                  case 0:
                    ...
                    _context13.next = 3;
                    return _this8._fetch('/whois-ns' + (fallback ? '-fallback' : '') + '?domain=' + encodeURIComponent(domain));
                  ...
                  case 12:
                    return _context13.abrupt('return', body);
    ...
    value: function setupDomain(name) {
      ...
      var _ref20 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          isExternal = _ref20.isExternal;

      return this.retry(function () {
        var _ref21 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee14(bail, attempt) {
            ...
            while (1) {
              switch (_context14.prev = _context14.next) {
                ...
                case 8:
                  ...
                  err.userError = true;
                  return _context14.abrupt('return', bail(err));
                ...
                case 16:
                  ...
                  return _context14.abrupt('return', { uid: body.error.uid });
    ...
    value: function createCert(domain) {
      ...
      return this.retry(function () {
        var _ref23 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(bail, attempt) {
            ...
            while (1) {
              switch (_context15.prev = _context15.next) {
                case 0:
                  ...
                  _context15.next = 3;
                  return _this10._fetch('/now/certs', {
                    method: 'POST',
                    body: {
                      domains: [domain],
                      renew: renew
                ...
                case 19:
                  ...
                  _err.userError = true;
                  // dont retry
                  return _context15.abrupt('return', bail(_err));
    ...
    value: function deleteCert(domain) {
      ...
      return this.retry(function () {
        var _ref24 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee16(bail, attempt) {
          var res, err;
            ...
            while (1) {
              switch (_context16.prev = _context16.next) {
                case 0:
                  ...
                  _context16.next = 3;
                  return _this11._fetch('/now/certs/' + domain, {
                    method: 'DELETE'
                  });
    ...
    key: 'remove',
    value: function () {
      var _ref25 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee18(deploymentId, _ref26) {
        var _this12 = this;

        var hard = _ref26.hard;
        var data;
          ...
          while (1) {
            switch (_context18.prev = _context18.next) {
              case 0:
                ...
                _context18.next = 3;
                return this.retry(function () {
                  var _ref27 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee17(bail) {
                    var res;
                      ...
                      while (1) {
                        switch (_context17.prev = _context17.next) {
                          case 0:
                            ...
                            _context17.next = 3;
                            return _this12._fetch('/now/remove', {
                              method: 'DELETE',
                              body: data
                            });
                          ...
                          case 3:
                            ...
                            return _context17.abrupt('return', bail(responseError(res)));
    ...
    value: function retry(fn) {
      var _ref28 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          _ref28$retries = _ref28.retries,
          retries = _ref28$retries === undefined ? 3 : _ref28$retries,
          _ref28$maxTimeout = _ref28.maxTimeout,
          maxTimeout = _ref28$maxTimeout === undefined ? Infinity : _ref28$maxTimeout;
    ...
    get: function get() {
      ...
      if (!this._syncAmount) {
        this._syncAmount = this._missing.map(function (sha) {
          return _this13._files.get(sha).data.length;
        }).reduce(function (a, b) {
          return a + b;
        }, 0);
      }
